    ...
    jobs: [
      {
        ...
        achievements: [
          'Built a test automation solution from scratch, oriented on team collaboration with static code analysis, and clearly defined code style',
          'Implemented parallel test execution, improving test stability, independence, and reducing execution time',
          'Fully automated smoke test suite and integrated it into CI/CD pipelines, enabling faster feedback on builds',
          'Automated ~20% of the regression test suite (≈140 out of 700 test cases) within 2 months, increasing test coverage and reducing manual testing effort',
          'Reduced automated test creation time by three times by implementing an AI approach to test development',
        ],
        responsibilities: [
          'Developed and maintained a test automation solution (Playwright/TypeScript)',
          'Conducted code reviews to ensure code quality, consistency, and adherence to best practices',
          'Mentored QA engineers to migrate from manual to automated testing practices',
          'Analyzed product requirements (PBI) and created detailed test cases',
          'Managed test cases and test activities using Azure DevOps',
          'Investigated and analyzed defects, collaborating closely with developers for resolution',
          'Collaborated on CI pipeline setup and maintenance for automated test execution, Playwright test reporting, and integration with Azure DevOps',
          'Worked closely with distributed development teams (Ukraine & international)',
        ],
      },
      {
        id: 'j-02',
